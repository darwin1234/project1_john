...
<head>
  ...
  <link href="<?php echo get_template_directory_uri(); ?>/css/fontawesome-free/css/all.min.css" rel="stylesheet">
  ...
  <header class="masthead">
    <div class="container d-flex h-100 align-items-center">
      <div class="mx-auto text-center">
        <h1 class="mx-auto my-0 text-uppercase text-white-50">Rodney Square Conservancy</h1>
